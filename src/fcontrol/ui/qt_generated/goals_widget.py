...
class Ui_GoalsWidget(object):
    def setupUi(self, GoalsWidget):
        ...
        self.groupBox.setGeometry(QRect(20, 10, 421, 131))
        ...
        self.label_4.setGeometry(QRect(10, 100, 81, 16))
        ...
        self.targetDateInput.setGeometry(QRect(90, 100, 110, 22))
        ...
        self.listWidget.setGeometry(QRect(30, 150, 411, 181))
    ...
    def retranslateUi(self, GoalsWidget):
        ...
        self.label_4.setText(QCoreApplication.translate("GoalsWidget", u"Target date", None))
